export const eventTicketAbi = [
  ...
  },
  {
    ...
    "name": "AccessControlBadAdminDelay",
    "type": "error"
  },
  {
    "inputs": [
    ...
    "name": "AccessControlEnforcedDefaultAdmin",
    "type": "error"
  },
  { "inputs": [], "name": "AccessControlInvalidDefaultAdmin", "type": "error" },
  {
    "inputs": [
      { "internalType": "address", "name": "account", "type": "address" },
      { "internalType": "bytes32", "name": "role", "type": "bytes32" }
  ...
  { "inputs": [{ "internalType": "address", "name": "owner", "type": "address" }], "name": "ERC721IncorrectOwner", "type": "error" },
  {
    "inputs": [
